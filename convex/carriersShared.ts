...
export const CARRIERS: Record<string, { name: string; country: string }> = {
  ...
  IX: { name: 'Air India Express', country: 'IN' },
  I5: { name: 'AirAsia India', country: 'IN' },
  SG: { name: 'SpiceJet', country: 'IN' },
  QP: { name: 'Akasa Air', country: 'IN' },
  UK: { name: 'Vistara', country: 'IN' },
  FZ: { name: 'flydubai', country: 'AE' },
  G9: { name: 'Air Arabia', country: 'AE' },
