...
// Same job for the flight-path cache, whose provider allows thirty days —
// see flightPaths.prune.
crons.interval('prune cached flight paths', { hours: 6 }, internal.flightPaths.prune, {});
