...
| 4 | 0:33–0:49 | **Travel Day Live**: live hero with running light → timeline → next step → Dynamic Island → Lock Screen Live Activity | On the day you fly, the home screen becomes a boarding pass. It counts down to departure, shows the gate the moment the airport posts it, and walks you through check-in, security and boarding. A Live Activity keeps it in the Dynamic Island and on your Lock Screen. |
| 5 | 0:49–0:59 | **People** panel (still): Eve live HNL→LAX, Following/Followers | The people who care can follow your travel day live: the plane on the route, delays as they happen, and the moment you land. Nobody has to ask whether you got there. |
| 6 | 0:59–1:16 | **Verdict → claim**: HEL→MAD landed 3h15 late → “You’re owed 400 EUR” (+ Generate my claim → name/email → letter once the demo user is Pro, see README) | And when a flight does go wrong, FlyRight already knows. This one landed three hours late. Under EU261, that’s four hundred euros, and one tap drafts the claim letter, ready to send. No legalese, and no middleman taking a cut. |
