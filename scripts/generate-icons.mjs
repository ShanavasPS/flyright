 ...
 * contrail sweeps into a checkmark (flight + claim approved). Platinum plane
 * and silver-grey vapor dots on a night-sky navy (see src/constants/theme.ts
 * and the passport card in travel-stats-header.tsx, which this icon mirrors).
 */
...
const bg = (size, { top = NAVY_LIFT, bottom = NAVY_DEEP, mid = NAVY } = {}) => `
  <defs>
    ...
    <radialGradient id="vignette" cx="0.12" cy="0.92" r="1.1">
      <stop offset="0" stop-color="#01040C" stop-opacity="0.4"/>
      <stop offset="0.55" stop-color="#01040C" stop-opacity="0"/>
    </radialGradient>
  </defs>
