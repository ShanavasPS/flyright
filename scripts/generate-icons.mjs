...
export const glyph = (size, scale, opts) => {
  const g = size * scale;
...
export const bg = (size, { top = NAVY_LIFT, bottom = NAVY_DEEP, mid = NAVY } = {}) => `
  <defs>
...
const TAB_GLYPHS = {
  ...
  // Material "group": two people — the People (circle) tab.
  people: `<path fill="#000" d="M16 11c1.66 0 2.99-1.34 2.99-3S17.66 5 16 5c-1.66 0-3 1.34-3 3s1.34 3 3 3zm-8 0c1.66 0 2.99-1.34 2.99-3S9.66 5 8 5C6.34 5 5 6.34 5 8s1.34 3 3 3zm0 2c-2.33 0-7 1.17-7 3.5V19h14v-2.5c0-2.33-4.67-3.5-7-3.5zm8 0c-.29 0-.62.02-.97.05 1.16.84 1.97 1.97 1.97 3.45V19h6v-2.5c0-2.33-4.67-3.5-7-3.5z"/>`,
  // Material "dynamic_feed": stacked cards — the Updates tab, where the
  // postcards and the faces of whoever is flying arrive.
  updates: `<path fill="#000" d="M8 8H6v7c0 1.1.9 2 2 2h9v-2H8V8zm12-5h-8c-1.1 0-2 .9-2 2v6c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 8h-8V7h8v4zM4 12H2v7c0 1.1.9 2 2 2h9v-2H4v-7z"/>`,
...
// Only write the app assets when run directly; generate-social-assets.mjs
// imports the drawing helpers above without re-rendering everything.
