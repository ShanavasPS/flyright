...
jest.mock('@/services/purchases', () => ({
  getCurrentOffering: async () => ({ availablePackages: [
    { identifier: 'monthly', packageType: 'MONTHLY', product: { priceString: '₹499.00', subscriptionPeriod: 'P1M' } },
...
beforeEach(() => { jest.clearAllMocks(); mockUserId = 'traveller'; mockBillingUser = 'traveller'; mockParams = { journeyId: 'trip-a', next: '/claim-wizard?journeyId=trip-a' }; mockConfirm.mockResolvedValue(true); mockRestore.mockResolvedValue(false); jest.spyOn(Alert, 'alert').mockImplementation(() => {}); });
