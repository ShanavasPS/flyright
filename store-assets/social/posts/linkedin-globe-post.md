...
Video: `demo/out/globe/flyright-globe.mp4` (34 s, 1080 × 1350, one iPhone, captions burned in, works muted). Cover: `flyright-globe-cover.png`. Captions also in `flyright-globe.srt`. Recipe in `scripts/globe-demo/README.md`.
