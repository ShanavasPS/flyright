...
const TRIPS = [
  ["demo-upcoming","British Airways","GB","BA117","LHR","JFK",now + UPCOMING_OFFSET,8.1],
  ["demo-lis","Lufthansa","DE","LH1166","FRA","LIS",now - 38 * DAY + 3 * HOUR,3.1],
  ["demo-bcn","Ryanair","IE","FR2341","DUB","BCN",now - 62 * DAY + 4 * HOUR,2.5],
  ["demo-ams","KLM","NL","KL1008","LHR","AMS",now - 90 * DAY + 4 * HOUR,1.3],
  ["demo-fco","Air France","FR","AF1204","CDG","FCO",now - 121 * DAY + 3 * HOUR,2.1],
  ["demo-fra","Lufthansa","DE","LH903","LHR","FRA",now - 160 * DAY + 4 * HOUR,1.6],
  ["demo-fco2","British Airways","GB","BA548","LHR","FCO",now - 205 * DAY + 4 * HOUR,2.6],
  ["demo-ath","Finnair","FI","AY1801","HEL","ATH",now - 250 * DAY + 2 * HOUR,3.7],
  ["demo-dub","Ryanair","IE","FR206","STN","DUB",now - 300 * DAY + 4 * HOUR,1.3],
  ["demo-mad","Air France","FR","AF1000","CDG","MAD",now - 345 * DAY + 3 * HOUR,2.1],
];
